...
int8_t R_FORW = 6;
int8_t R_BACK = 5;
int8_t R_enablePin = 9;
int8_t R_encoderPin1 = 2;  //Encoder Output of pin1 must connected with intreput pin of Esp32.
...
void publish_tick_data() {


  RCSOFTCHECK(rcl_publish(&left_tick_publisher, &leftWheel.EncoderCount, NULL));
  RCSOFTCHECK(rcl_publish(&right_tick_publisher, &rightWheel.EncoderCount, NULL));
